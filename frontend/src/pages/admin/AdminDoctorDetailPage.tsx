...
const AdminDoctorDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchDoctorData = async () => {
      ...
      try {
        ...
        // Fetch doctor details, appointments, and reviews in parallel
  ...
  if (error) {
    return (
      <div className="p-6">
        <Link to="/admin/doctors" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-4">
    ...
    <div className="min-h-screen bg-background rounded-[16px]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex justify-between items-center">
          <Link to="/admin/doctors" className="inline-flex items-center text-sm text-blue-600 hover:text-blue-700 font-medium group">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mb-3">
                    ...
                    {doctor.id && (
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-red-100">
                        ...
                        Mã: DB-{String(doctor.id).padStart(3, '0')}
                      </span>
                    )}
                  </div>
                  {doctor.bio && (
                    <p className="text-gray-700 text-sm leading-relaxed max-w-2xl">{doctor.bio}</p>
                  )}
                </div>
              </div>
              ...
              <div className="w-full lg:max-w-xs bg-background rounded-xl p-4 space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{doctor.email || 'Chưa cập nhật'}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{doctor.phone || 'Chưa cập nhật'}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{doctor.address || 'Chưa cập nhật'}</p>
                  </div>
                </div>
              </div>
            </div>
