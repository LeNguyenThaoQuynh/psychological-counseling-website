...
const AppointmentsPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (searchQuery) {
      filtered = filtered.filter(apt => 
        apt.service?.title?.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  const getProgressPercentage = (appointment: Appointment) => {
    ...
    return Math.round((appointment.progress.completed_sessions / appointment.progress.total_sessions) * 100);
  };
  ...
  const statusOptions = [
    ...
    { value: 'completed', label: 'Đã hoàn thành', count: appointments.filter(a => a.status === 'completed').length },
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex justify-center items-center">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 font-medium">Đang tải lịch hẹn...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-white">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">Quản lý và theo dõi các buổi tư vấn của bạn</p>
          </div>
                ...
                >
                  ...
                  <div className="bg-mint p-6">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      >
                        {appointment.status === 'confirmed' && <LuCheck className="inline h-3 w-3 mr-1" />}
                        {appointment.status === 'cancelled' && <LuX className="inline h-3 w-3 mr-1" />}
                    ...
                    {appointment.progress && (
                      <div className="mb-4">
                        <div className="flex justify-between text-sm mb-2">
                          ...
                          <span>{appointment.progress.completed_sessions}/{appointment.progress.total_sessions} buổi</span>
                        </div>
                        <div className="w-full bg-white bg-opacity-20 rounded-full h-2">
                          <div 
                            className="bg-white h-2 rounded-full transition-all duration-500"
                            style={{ width: `${getProgressPercentage(appointment)}%` }}
                          ></div>
                        </div>
                      </div>
                    )}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center mb-4 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        <p className="font-semibold text-gray-800">{formatDate(appointment.scheduled_at)}</p>
