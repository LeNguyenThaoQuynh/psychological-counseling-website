...
import { 
  LuHouse, LuPackage, LuUsers, LuMessagesSquare, LuStar, LuLogOut, LuCalendar, 
  LuStethoscope,
  LuSquareChartGantt
...
const AdminSidebar: React.FC = () => {
  ...
  const baseLinkClass = "flex items-center px-4 py-3 text-gray-700 hover:bg-green-100 hover:text-b rounded-lg transition-colors duration-150";
