...
import { LuImage, LuPlus, LuTrash2, LuCircleUserRound, LuUser, LuMail, LuPhone, LuMapPinned } from 'react-icons/lu';
...
interface AdminDoctorFormProps {
  ...
  initialData?: Partial<DoctorFormData> | null; // For edit mode
  isEditMode: boolean;
}

const AdminDoctorForm: React.FC<AdminDoctorFormProps> = ({ onSubmit, initialData, isEditMode }) => {
  ...
  useEffect(() => {
    if (initialData) {
      console.log('AdminDoctorForm - Received initialData:', initialData);
      const resetData: Partial<DoctorFormData> = {
        ...initialData,
      ...
      console.log('AdminDoctorForm - Reset data:', resetData);
      console.log('AdminDoctorForm - Qualifications:', resetData.qualifications);
      console.log('AdminDoctorForm - Experiences:', resetData.experiences);
      reset(resetData as DoctorFormData);
      ...
      console.log('AdminDoctorForm - No initialData, using defaults');
      reset({
        full_name: '',
        email: '',
        phone: '',
  ...
  const handleFormSubmit = (data: DoctorFormData) => {
    console.log("Doctor Form Data Submitted:", data);
