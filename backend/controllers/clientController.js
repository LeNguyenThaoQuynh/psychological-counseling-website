...
exports.createClient = async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'Mật khẩu tài khoản Lumen Histoire của bạn ',
      html: `
        <h1>Chào mừng bạn đến với trung tâm Lumen Histoire!</h1>
        <p>Thân gửi ${full_name},</p>
        <p>Tài khoản của bạn vừa được tạo thành công. Đây mà mật khẩu bạn sẽ dùng để đăng nhập:</p>
